...
**There is no outlier anymore in our new plots of scores and we are able to see in 3 biplots, they all have some overlapping between 3 food groups and the distance among these 3 food groups are near, as the nearer the distance are these 3 groups from each other, meaning there are more similarities among them (it is according to the variability that explain the two axes).**
...
**Because a PCA biplot simply merges an usual PCA plot with a plot of loadings. The arrangement for the first biplot is like this:**
