...
**We can see from the plot, we do not have any high negative correlation, but we do have many high positive correlations. Such as the correlation coefficient between Folate_mcg and Thiamin_mg is 1, which is perfect positive correlation, and others like Protein_g and Zinc_mg have a correlation coefficient of 0.9 which is considered high correlation. As well as the correlation coefficient between carb_g and sugar_g which is 0.8, this is also considered high correlation.** 
...
**There is no outlier anymore in our new plots of scores and we are able to see in 3 biplots, each PC is not separate from each other and there is some overlaping between between 3 food groups in each biplot. **
...
**So our biplots coincides with loadings of each PC.**
